      ...
      <table className="w-full text-left rtl:text-right">
        <thead className="uppercase bg-bgGreyLight">
          <tr className="">
            ...
            <th scope="col" className="px-6 py-3 font-semibold text-grey64 text-[1.6rem] rounded-r-2xl">
              STATUS
            </th>
          </tr>
        </thead>
          ...
          {payment_history.map((item, index) => {
            ...
            return (
              <tr key={index} className="bg-white border-b">
                <td scope="row" className="px-6 py-4 font-medium text-[1.6rem]">
                  {name}
                </td>
                <td className="px-6 py-4 text-[1.6rem]">{date}</td>
                <td className="px-6 py-4 text-[1.6rem]">{price}</td>
                <td className="px-6 py-4 text-[1.6rem]">{payment_type}</td>
