import { ArrowDownIcon, BellIcon, CancelIcon, LogoIcon, MenuIcon, MoonIcon, TrophyIcon } from "@/components/Icons.tsx"
  ...
  return (
    <div className="container h-[70px] flex items-center justify-between text-[1.5rem]">
      <div className="flex items-center">
        ...
        <div
          className={`absolute bg-opacityDark top-[70px] h-[100vh] w-full left-0 px-28 
