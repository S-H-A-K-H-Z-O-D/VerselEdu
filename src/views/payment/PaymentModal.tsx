...
import imgDone from "@/assets/images/payment/paymentDone.svg"
    ...
    <Dialog onOpenChange={() => setIsPaid(false)}>
      ...
      <DialogContent className="sm:max-w-[425px] rounded-3xl">
        <div className="flex flex-col items-center p-12">
          ...
          <h4 className="text-[clamp(1.8rem,_1.8vw,_2.4rem)] text-center pb-10 -mt-5 font-medium">
            Kurs to’lovi muvaffaqiyatli yakunlandi
          </h4>
          <Button className="h-[4.5rem] rounded-2xl">
            <Link to={"/courses"} className="text-[clamp(1.4rem,_1.4vw,_1.6rem)] px-10">
              Kursni ko'rish
            </Link>
          </Button>
        </div>
